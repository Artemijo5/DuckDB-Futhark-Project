...
=
	...
	let x1_info: partitionInfo = {maxDepth = max_depth1, bounds = bounds1, depths = depths1}
	let x2_info: partitionInfo = {maxDepth = max_depth2, bounds = bounds2, depths = depths2}
