...
=
	...
	let (xs1',is1) = partition_and_deepen 2 radix_size size_thresh max_depth xs1 (iota n1)
	let x1_info= calc_partInfo radix_size 0 size_thresh max_depth xs1'
	let x1_tbl = calc_radixHashTab radix_size x1_info xs1'
	let (xs2',is2) = partition_preconfigured 2 radix_size xs1' x1_info xs2 (iota n2)
	in (
