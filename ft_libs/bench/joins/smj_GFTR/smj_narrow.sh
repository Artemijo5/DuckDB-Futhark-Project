...
n1=$1
n2=$((2*n1))
#If any second argument is given, do all SMJ in one script.
combine=$2
...
futhark bench --backend=$futhark_backend --runs=$runs_No datagen_narrow.fut --entry-point="do_datagen_i32"
rm -f data/*.in
