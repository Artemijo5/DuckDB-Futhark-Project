...
futhark dataset \
	...
	-b -g \[$n1\]\[$b\]u8 \
	-b -g \[$n2\]\[$b\]u8 \
	--f64-bounds=$skew:$skew -b -g \[1\]f64 \
	> data/dat_i32.in

futhark bench --backend=$futhark_backend --runs=1 datagen_skewed.fut --entry-point="do_datagen_i32"
rm -f data/*.in
mv "data/datagen_skewed:do_datagen_i32-data_dat_i32.in.out" data/dat_i32.in
