...
int futhark_entry_internal_DBSCAN_double(struct futhark_context *ctx, struct futhark_opaque_flushedData_double **out0, const int64_t in0, const int64_t in1, const bool in2, const bool in3, const double in4, const double in5, const int64_t in6, const int64_t in7, const bool in8, const struct futhark_f64_1d *in9, const struct futhark_f64_1d *in10);
