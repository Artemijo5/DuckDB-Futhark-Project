...
// Entry points
int futhark_entry_calc_global_Skyline_GFUR_double(struct futhark_context *ctx, struct futhark_opaque_skylineInfo_GFUR_double **out0, const struct futhark_opaque_skylineBase_double *in0, const struct futhark_opaque_skylineInfo_GFUR_double *in1, const int64_t in2);
int futhark_entry_calc_global_Skyline_GFUR_float(struct futhark_context *ctx, struct futhark_opaque_skylineInfo_GFUR_float **out0, const struct futhark_opaque_skylineBase_float *in0, const struct futhark_opaque_skylineInfo_GFUR_float *in1, const int64_t in2);
...
int futhark_entry_pointwise_slice_and_dice_for_Skyline_GFUR_double(struct futhark_context *ctx, struct futhark_opaque_skylineInfo_GFUR_double **out0, const struct futhark_opaque_skylineBase_double *in0, const struct futhark_f64_2d *in1, const int64_t in2, const bool in3, const bool in4);
int futhark_entry_pointwise_slice_and_dice_for_Skyline_GFUR_float(struct futhark_context *ctx, struct futhark_opaque_skylineInfo_GFUR_float **out0, const struct futhark_opaque_skylineBase_float *in0, const struct futhark_f32_2d *in1, const int64_t in2, const bool in3, const bool in4);
