...
struct futhark_u8_1d *futhark_new_raw_u8_1d(struct futhark_context *ctx, CUdeviceptr data, int64_t dim0);
...
struct futhark_opaque_sortInfo_str;
...
struct futhark_opaque_sortStruct_str;
struct futhark_opaque_sortedHash_str_GFUR;
...
int futhark_project_opaque_joinPairs_str_str_info(struct futhark_context *ctx, struct futhark_opaque_strInfo **out, const struct futhark_opaque_joinPairs_str *obj);
int futhark_new_opaque_joinPairs_str(struct futhark_context *ctx, struct futhark_opaque_joinPairs_str **out, const struct futhark_i64_1d *f_ix, const struct futhark_i64_1d *f_iy, const struct futhark_opaque_strInfo *f_str_info);
...
int futhark_free_opaque_sortInfo_str(struct futhark_context *ctx, struct futhark_opaque_sortInfo_str *obj);
int futhark_store_opaque_sortInfo_str(struct futhark_context *ctx, const struct futhark_opaque_sortInfo_str *obj, void **p, size_t *n);
struct futhark_opaque_sortInfo_str *futhark_restore_opaque_sortInfo_str(struct futhark_context *ctx, const void *p);
int futhark_project_opaque_sortInfo_str_is(struct futhark_context *ctx, struct futhark_i64_1d **out, const struct futhark_opaque_sortInfo_str *obj);
int futhark_project_opaque_sortInfo_str_str_info(struct futhark_context *ctx, struct futhark_opaque_strInfo **out, const struct futhark_opaque_sortInfo_str *obj);
int futhark_new_opaque_sortInfo_str(struct futhark_context *ctx, struct futhark_opaque_sortInfo_str **out, const struct futhark_i64_1d *f_is, const struct futhark_opaque_strInfo *f_str_info);
...
int futhark_free_opaque_sortStruct_str(struct futhark_context *ctx, struct futhark_opaque_sortStruct_str *obj);
int futhark_store_opaque_sortStruct_str(struct futhark_context *ctx, const struct futhark_opaque_sortStruct_str *obj, void **p, size_t *n);
struct futhark_opaque_sortStruct_str *futhark_restore_opaque_sortStruct_str(struct futhark_context *ctx, const void *p);
int futhark_project_opaque_sortStruct_str_pL(struct futhark_context *ctx, struct futhark_u8_2d **out, const struct futhark_opaque_sortStruct_str *obj);
int futhark_project_opaque_sortStruct_str_str_info(struct futhark_context *ctx, struct futhark_opaque_strInfo **out, const struct futhark_opaque_sortStruct_str *obj);
int futhark_new_opaque_sortStruct_str(struct futhark_context *ctx, struct futhark_opaque_sortStruct_str **out, const struct futhark_u8_2d *f_pL, const struct futhark_opaque_strInfo *f_str_info);
int futhark_free_opaque_sortedHash_str_GFUR(struct futhark_context *ctx, struct futhark_opaque_sortedHash_str_GFUR *obj);
int futhark_store_opaque_sortedHash_str_GFUR(struct futhark_context *ctx, const struct futhark_opaque_sortedHash_str_GFUR *obj, void **p, size_t *n);
struct futhark_opaque_sortedHash_str_GFUR *futhark_restore_opaque_sortedHash_str_GFUR(struct futhark_context *ctx, const void *p);
int futhark_project_opaque_sortedHash_str_GFUR_is(struct futhark_context *ctx, struct futhark_i64_1d **out, const struct futhark_opaque_sortedHash_str_GFUR *obj);
int futhark_project_opaque_sortedHash_str_GFUR_ks(struct futhark_context *ctx, struct futhark_u8_2d **out, const struct futhark_opaque_sortedHash_str_GFUR *obj);
int futhark_new_opaque_sortedHash_str_GFUR(struct futhark_context *ctx, struct futhark_opaque_sortedHash_str_GFUR **out, const struct futhark_i64_1d *f_is, const struct futhark_u8_2d *f_ks);
...
int futhark_project_opaque_strInfo_str_content(struct futhark_context *ctx, struct futhark_u8_1d **out, const struct futhark_opaque_strInfo *obj);
int futhark_project_opaque_strInfo_str_idx(struct futhark_context *ctx, struct futhark_i64_1d **out, const struct futhark_opaque_strInfo *obj);
int futhark_new_opaque_strInfo(struct futhark_context *ctx, struct futhark_opaque_strInfo **out, const struct futhark_u8_1d *f_str_content, const struct futhark_i64_1d *f_str_idx);
...
int futhark_entry_arith_sort_str_GFTR(struct futhark_context *ctx, struct futhark_opaque_sortStruct_str **out0, const struct futhark_u8_1d *in0, const struct futhark_i64_1d *in1, const struct futhark_u8_2d *in2, const int64_t in3);
int futhark_entry_arith_sort_str_GFUR(struct futhark_context *ctx, struct futhark_opaque_sortInfo_str **out0, const struct futhark_u8_1d *in0, const struct futhark_i64_1d *in1, const int64_t in2, const int64_t in3);
int futhark_entry_arith_sort_str_caseInsens_GFTR(struct futhark_context *ctx, struct futhark_opaque_sortStruct_str **out0, const struct futhark_u8_1d *in0, const struct futhark_i64_1d *in1, const struct futhark_u8_2d *in2, const int64_t in3);
int futhark_entry_arith_sort_str_caseInsens_GFUR(struct futhark_context *ctx, struct futhark_opaque_sortInfo_str **out0, const struct futhark_u8_1d *in0, const struct futhark_i64_1d *in1, const int64_t in2, const int64_t in3);
int futhark_entry_arith_sorted_str_rank_count(struct futhark_context *ctx, struct futhark_opaque_sortgroupInfo **out0, const struct futhark_opaque_strInfo *in0);
int futhark_entry_arith_sorted_str_rank_count_caseInsens(struct futhark_context *ctx, struct futhark_opaque_sortgroupInfo **out0, const struct futhark_opaque_strInfo *in0);
...
int futhark_entry_gather_str(struct futhark_context *ctx, struct futhark_opaque_strInfo **out0, const int64_t in0, const struct futhark_i64_1d *in1, const struct futhark_u8_1d *in2, const struct futhark_i64_1d *in3);
int futhark_entry_hash_str_col(struct futhark_context *ctx, struct futhark_u8_2d **out0, const int64_t in0, const int64_t in1, const int64_t in2, const int64_t in3, const int64_t in4, const bool in5, const int64_t in6, const struct futhark_opaque_strInfo *in7);
...
int futhark_entry_sortMergeJoin_str(struct futhark_context *ctx, struct futhark_opaque_joinPairs_str **out0, const struct futhark_opaque_strInfo *in0, const struct futhark_opaque_strInfo *in1, const int64_t in2, const int64_t in3, const int64_t in4, const int64_t in5);
int futhark_entry_sortMergeJoin_str_caseInsens(struct futhark_context *ctx, struct futhark_opaque_joinPairs_str **out0, const struct futhark_opaque_strInfo *in0, const struct futhark_opaque_strInfo *in1, const int64_t in2, const int64_t in3, const int64_t in4, const int64_t in5);
int futhark_entry_sort_hashed_strs_GFUR(struct futhark_context *ctx, struct futhark_opaque_sortedHash_str_GFUR **out0, const struct futhark_u8_2d *in0);
...
int futhark_entry_split_words_from_text(struct futhark_context *ctx, struct futhark_opaque_strInfo **out0, const bool in0, const struct futhark_u8_1d *in1);
