...
Joins:
	...
	$(CC) c_tests/src/duckdb_string_SMJ.c -o c_tests/duckdb_join_str.o $(CFLAGS) $(DEPS) ft_clibs/libjoin.so
...
C-Joins:
	...
	$(CC) c_tests/src/duckdb_string_SMJ.c -o c_tests/duckdb_join_str.o $(CFLAGS) $(DEPS) ft_clibs/join_entry.c