...
int futhark_entry_filter_and_fit_for_Skyline_GFUR_double(struct futhark_context *ctx, struct futhark_opaque_skylineInfo_GFUR_double **out0, const struct futhark_opaque_skylineBase_double *in0, const struct futhark_opaque_skylineBase_double *in1, const struct futhark_f64_2d *in2, const int64_t in3, const bool in4, const bool in5);
